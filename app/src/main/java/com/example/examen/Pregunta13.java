...
public class Pregunta13 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta13);
        i = new Intent(Pregunta13.this, Pregunta14.class);
        a = (Button)findViewById(R.id.a13);
        b = (Button)findViewById(R.id.b13);
        c = (Button)findViewById(R.id.c13);
        siguien = (Button)findViewById(R.id.siguiente13);
        try {
            recibe = getIntent();
