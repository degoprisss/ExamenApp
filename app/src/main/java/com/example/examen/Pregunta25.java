...
public class Pregunta25 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta25);
        i = new Intent(Pregunta25.this, Pregunta26.class);
        a = (Button)findViewById(R.id.a25);
        b = (Button)findViewById(R.id.b25);
        c = (Button)findViewById(R.id.c25);
        siguien = (Button)findViewById(R.id.siguiente25);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.b25:
                ...
                deshabilitar();
                break;
            case R.id.c25://Respuesta correcta
                calificacion += 100;
                c.setBackgroundColor(Color.CYAN);
                deshabilitar();
                break;
            case R.id.siguiente25:
                startActivity(i);
                break;
            default:
                break;
