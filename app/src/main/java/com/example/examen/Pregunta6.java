...
public class Pregunta6 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = (Button)findViewById(R.id.a6);
        b = (Button)findViewById(R.id.b6);
        c = (Button)findViewById(R.id.c6);
        siguien = (Button)findViewById(R.id.siguiente6);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.a6://respuesta correcta
                calificacion += 100;
