...
public class Pregunta30 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta30);
        i = new Intent(Pregunta30.this, Resultado.class);
        a = (Button)findViewById(R.id.a30);
        b = (Button)findViewById(R.id.b30);
        c = (Button)findViewById(R.id.c30);
        siguien = (Button)findViewById(R.id.siguiente30);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.a30:
                ...
                break;
            case R.id.b30://Respuesta correca
                calificacion += 100;
