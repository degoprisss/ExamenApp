...
public class Pregunta22 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta22);
        i = new Intent(Pregunta22.this, Pregunta23.class);
        a = (Button)findViewById(R.id.a22);
        b = (Button)findViewById(R.id.b22);
        c = (Button)findViewById(R.id.c22);
        siguien = (Button)findViewById(R.id.siguiente22);
        try {
            recibe = getIntent();
