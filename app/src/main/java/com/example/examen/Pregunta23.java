...
public class Pregunta23 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta23);
        i = new Intent(Pregunta23.this, Pregunta24.class);
        a = (Button)findViewById(R.id.a23);
        b = (Button)findViewById(R.id.b23);
        c = (Button)findViewById(R.id.c23);
        siguien = (Button)findViewById(R.id.siguiente23);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.a23: //Respuesta correcta
                calificacion += 100;
