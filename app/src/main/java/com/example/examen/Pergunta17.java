...
public class Pergunta17 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pergunta17);
        i = new Intent(Pergunta17.this, Pregunta18.class);
        a = (Button)findViewById(R.id.a17);
        b = (Button)findViewById(R.id.b17);
        c = (Button)findViewById(R.id.c17);
        siguien = (Button)findViewById(R.id.siguiente17);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.a17://respuesta correcta
                calificacion += 100;
