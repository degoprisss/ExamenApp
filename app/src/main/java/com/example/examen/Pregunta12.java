...
public class Pregunta12 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta12);
        i = new Intent(Pregunta12.this, Pregunta13.class);
        a = (Button)findViewById(R.id.a12);
        b = (Button)findViewById(R.id.b12);
        c = (Button)findViewById(R.id.c12);
        siguien = (Button)findViewById(R.id.siguiente12);
        try {
            recibe = getIntent();
