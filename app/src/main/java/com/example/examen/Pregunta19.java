...
public class Pregunta19 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregunta19);
        i = new Intent(Pregunta19.this, Pregunta20.class);
        a = (Button)findViewById(R.id.a19);
        b = (Button)findViewById(R.id.b19);
        c = (Button)findViewById(R.id.c19);
        siguien = (Button)findViewById(R.id.siguiente19);
        try {
            recibe = getIntent();
